...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupSecurityResources() {
        ...
        createUserIfNotFound("admin", "1111", "admin@mail.com", roles);
    ...
    public void createRoleHierarchyIfNotFound(Role childRole, Role parentRole) {
        ...
        RoleHierarchy roleHierarchy = roleHierarchyRepository.findByName(parentRole.getRoleName());
        ...
        roleHierarchy = roleHierarchyRepository.findByName(childRole.getRoleName());
        if (roleHierarchy == null) {
            roleHierarchy = RoleHierarchy.builder()
